# Interface_basededados
Interface para uma base de dados relacionada com avistamentos de Orcas

## Como ligar o server da base de dados
1- SQL Server Configuration Manager -> SQL Server Network Configuration -> Dar Enable aos Protocologos
